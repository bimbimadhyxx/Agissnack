...
class Skin_Grid extends Skin_Base
{
    ...
    public function generate_output($settings = false ,$with_wrapper = true){
        ...
        if(in_array($grid_layout, ['default', 'smart-grid', 'checker-board']) && $masonry !== 'yes'){
            $this->parent->add_render_attribute('outer-wrapper', 'class', 'ae-height-100');
        }

        if($settings['source'] == 'current_loop' || $this->get_instance_value('disable_ajax') == 'yes'){
        ...
        if($masonry == 'yes'){
            ...
            //$column_gap = $this->get_instance_value('item_col_gap');
            //$this->parent->add_render_attribute('outer-wrapper', 'data-gutter', $column_gap['size']);
        }
        ...
        if($item_reveal_animation == 'yes' && $enable_overlay == 'yes'){
            ...
            //$overlay_animation_speed = $this->get_instance_value('overlay_animation_speed');
        ...
        if($ias == 'yes'){
            ...
            <?php if($ias_load_with_button == 'yes' && $settings['layout'] != 'carousel') { ?>
    ...
    public function get_grid_controls(Widget_Base $widget){
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    //'{{WRAPPER}} .ae-post-collection' => 'grid-template-columns: repeat({{VALUE}}, 1fr); display:grid',
                    '{{WRAPPER}} .ae-post-collection' => 'grid-template-columns: repeat({{VALUE}}, minmax(0, 1fr)); display:grid',
                    //'{{WRAPPER}} .ae-masonry-yes .ae-post-collection' => 'display:flex; justify-content: space-between',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    //'{{WRAPPER}} .ae-masonry-yes .ae-post-collection .ae-post-item' => 'width: calc((100% - ({{grid_columns.VALUE}} * {{SIZE}}px)) / {{grid_columns.VALUE}}); padding-right: {{SIZE}}px',
    ...
    function pagination_style_controls(){
    ...
    function infinite_scroll_style_controls(){
    ...
    function loading_overlay(){
        ...
        /*$this->add_control(
            'overlay_loading_text_transition_divider',
            [
                'type' => Controls_Manager::DIVIDER,
                'style' => 'thick',
                'condition' => [
                    $this->get_control_id('item_reveal_animation') => 'yes'
                ]
            ]
        );
    ...
    function loading_overlay_style(){
        $this->start_controls_section(
    ...
    function pagination_markup($settings, $post_items){
        ...
        if($this->get_instance_value('show_pagination') != 'yes' && $this->get_instance_value('show_infinite_scroll') == ''){
            return;
        }
        ...
        <div <?php echo $this->parent->get_render_attribute_string('pagination-wrapper'); ?>>
            ...
            if( !isset($disable_ajax) || $disable_ajax == 'yes' ){
