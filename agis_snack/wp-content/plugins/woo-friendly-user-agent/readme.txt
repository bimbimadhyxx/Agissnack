...
== Installation ==
**Friendly User Agent for WooCommerce** requires the [WooCommerce](https://wordpress.org/plugins/woocommerce/ "WooCommerce") plugin (at least version 2.5.5) to be installed. Tested from WooCommerce 2.5.5 to 3.5.5.
