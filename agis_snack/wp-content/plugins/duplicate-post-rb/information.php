...
<div class="rbs_nw_wrap">
    <div class="rbs_nw_item">
        <div class="rbs_nw_item_logo">
            <img class="rbs_nw_item_logo_ro" src="<?php echo RB_DUPLICATE_POST_URL; ?>assets/images/logo_rg.gif" width="150" hight="150">
        </div>
    ...
    <div class="rbs_nw_item">
        <div class="rbs_nw_item_logo">
            <img class="rbs_nw_item_logo_upz" src="<?php echo RB_DUPLICATE_POST_URL; ?>assets/images/upzilla_black_logo.svg" width="225" hight="100">
        </div>
        <h3 class="rbs_nw_item_header">
